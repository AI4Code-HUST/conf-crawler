CONF_LISTS = [
    ...
    "https://dblp.uni-trier.de/db/conf/uist",
    "https://dblp.uni-trier.de/db/journals/toms",
    ...
    "https://dblp.uni-trier.de/db/journals/iee/",
